...
var Quiz = function(quizContainer, answers) {
   ...
   */
  this.unansweredQuestionText = 'Réponse vide!';
  ...
  //Modification pour pouvoir chercher les réponses dans toute la desendance
  var truc = $("#" + this.container.id + " ."+Quiz.Classes.QUESTION);
  for (var i=0; i < truc.length; i++) {
    this.questions.push(truc[i]);
  }
